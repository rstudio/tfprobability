...
[![AppVeyor build status](https://ci.appveyor.com/api/projects/status/github/rstudio/tfprobability?branch=master&svg=true)](https://ci.appveyor.com/project/rstudio/tfprobability)
<!-- badges: end -->
...
are described in the vignettes/articles and/or featured on the [TensorFlow for R blog](https://blogs.rstudio.com/tensorflow/).
